  ...
  return (
    <div className="h-full flex flex-col bg-background">
      <div className="h-8.75 flex items-center border-b bg-sidebar shrink-0">
        ...
        <div className="flex-1 h-full flex items-center px-2 bg-background border-x text-xs text-muted-foreground truncate font-mono">
          {isLoading && (
      ...
      <div className="flex-1 min-h-0">
        <Allotment vertical>
          <Allotment.Pane>
            ...
            {isLoading && !error && (
              <div className="size-full flex items-center justifyt-center text-muted-foreground">
                <div className="flex flex-col items-center gap-2 max-w-md mx-auto text-center">

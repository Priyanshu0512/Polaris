...
// responsible for generating suggestions from AI.
...
// responsible for rendering the suggestions onto the editor.
const renderPlugin = ViewPlugin.fromClass(
  class {
    ...
    build(view: EditorView) {
      ...
      // creating a widget decoration at the cursor position
